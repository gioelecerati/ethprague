<template>
  <div class="schedule-event-box" :style="getEventBoxStyle()">
    <div
...
const getEventBoxStyle = () => {
  const calcMinHeight = props.rowspan && props.rowspan * 75 || 0;
  return {minHeight: `${calcMinHeight}px`}
}
